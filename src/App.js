  ...
  return (
    <div className="App">
      <header className="App-header">
        <img
          src={coverwallet}
          className="App-logoCoverwallet"
          alt="Coverwallet"
        />
        <a
          className="fa fa-github btnGit"
          href="https://github.com/saralerma"
      ...
      <section className="Intro">
        ...
        <p className="Description">
          <i>
            Fibonacci sequence is calculated in such a way that each number is
            the sum of the previous two, starting with 0 and 1.
          </i>
        </p>
